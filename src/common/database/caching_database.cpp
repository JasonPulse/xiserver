...
auto db::CachingDatabase::runWithRetry(const std::string& rawQuery, const std::function<std::unique_ptr<ResultSet>(detail::ConnectionState&)>& operation) -> std::unique_ptr<ResultSet>
{
