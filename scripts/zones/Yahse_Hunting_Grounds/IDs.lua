...
zones[xi.zone.YAHSE_HUNTING_GROUNDS] =
{
    text =
    {
        ...
        SHELLFISH_ON_BEACH            = 7515, -- Large, succulent shellfish line the beach.
        APPROACHING_FROM_SHADOWS      = 7530, -- You feel something approaching from the shadows.
        COLLECT_SHELLFISH             = 7516, -- You collect a shellfish from the ground. (<number> of 5)
        ALREADY_ENOUGH_SHELLFISH      = 7517, -- You already have enough shellfish.
        SHELLFISH_DISAPPEARED         = 7518, -- The shellfish disappeared.
