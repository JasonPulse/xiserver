...
zones[xi.zone.GRAUBERG_S] =
{
    text =
    {
        ...
        GOLD_GRAINS_RETRIEVED         = 7939, -- <name> successfully retrieved <number> grain[/s] of gold and placed them in his/her <keyitem>. (Total: <number> grain[/s].)
        LEAVE_AREA_LOSE_GOLD_DUST     = 7940, -- If you leave the area before acquiring a minimum of <number> grains, you will lose all the gold dust you have acquired.
