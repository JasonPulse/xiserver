...
zones[xi.zone.MAZE_OF_SHAKHRAMI] =
{
    text =
    {
        ...
        COIN_CONSTELLATION_OFFSET     = 7084,  -- You picked up a coin with Alexander drawn to the northeast. (7084-7091, four genuine and four forged)
        ...
        OINTMENT_DRAWS_MONSTERS       = 7320,  -- The ointment's odor draws out the monsters!
