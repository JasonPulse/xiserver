...
zones[xi.zone.ABYSSEA_TAHRONGI] =
{
    text =
    {
        ...
        CARDIAN_GREETING              = 8045, -- [GrEEtIngS/FaREwELL]! [star] THe [star] aReA ...
        CARDIAN_WARNING               = 8046, -- WaRNiNG! [star] [DaNGeRoUS/SqUIsHy] [star] FiENdS ...
        CARDIAN_ALL_CLEAR             = 8047, -- aLL [star] ClEAr! [star] WiTH [star] mE [star] ...
        CARDIAN_WELCOME               = 8048, -- WeLCoME! [star] YoU [star] aRe [star] QUiTe [star] ...
    },
    mob =
    {
