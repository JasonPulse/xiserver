...
zones[xi.zone.MAMOOL_JA_TRAINING_GROUNDS] =
{
    ...
    mob =
    {
        ...
        [xi.assault.mission.SAGELORD_ELIMINATION] =
        {
            MOBS_START =
            {
                SAGELORD_MOLAAL_JA = 17047590,
                17047591, 17047592, 17047594, 17047595, 17047597, 17047598, 17047599,
                17047600, 17047601, 17047602, 17047603, 17047605, 17047606, 17047608,
            },
        },
    },
