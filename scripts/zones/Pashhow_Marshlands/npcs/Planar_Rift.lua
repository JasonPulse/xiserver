...
-- Entities 17224371-73 ; CSIDs 6000-6002 verified via xidat.
-----------------------------------
...
entity.onTrigger = function(player, npc)
    ...
    printf('[Planar_Rift_Pashhow] onTrigger: npc=%d csid=%d voidstones=%d/%d cruor=%d',
...
entity.onEventUpdate = function(player, csid, option, npc)
    printf('[Planar_Rift_Pashhow] onEventUpdate: csid=%d option=%d (0x%08X)', csid, option, option)
end

entity.onEventFinish = function(player, csid, option, npc)
    printf('[Planar_Rift_Pashhow] onEventFinish: csid=%d option=%d (0x%08X)', csid, option, option)
end
