...
--
-- csid 441 is decoded from our own client DAT dump: it is the only event on entity
-- 17744187, and its data table is identical to the other two ports' Skipper Moogles,
...
local bookShopEvent = 441

entity.onTrigger = function(player, npc)
    xi.mog_garden.vendor.onTrigger(player)

    return player:startEvent(bookShopEvent, xi.mog_garden.vendor.nation[xi.zone.PORT_BASTOK],
