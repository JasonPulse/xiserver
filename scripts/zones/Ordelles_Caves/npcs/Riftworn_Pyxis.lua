...
-- Entities 17568202-04 ; CSIDs 6003-6005 verified via xidat.
-----------------------------------
...
entity.onTrigger = function(player, npc)
    ...
    printf('[Riftworn_Pyxis_Ordelle] onTrigger: npc=%d csid=%d voidstones=%d',
...
entity.onEventUpdate = function(player, csid, option, npc)
    printf('[Riftworn_Pyxis_Ordelle] onEventUpdate: csid=%d option=%d (0x%08X)', csid, option, option)
end

entity.onEventFinish = function(player, csid, option, npc)
    printf('[Riftworn_Pyxis_Ordelle] onEventFinish: csid=%d option=%d (0x%08X)', csid, option, option)
