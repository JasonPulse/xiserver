...
entity.onTrigger = function(player, npc)
    xi.eschanHub.onSageTrigger(player, 'Shiftrix', xi.ki.MAP_OF_REISENJIMA)
end

entity.onEventUpdate = function(player, csid, option, npc)
    xi.eschanHub.onSageEventUpdate(player, 'Shiftrix', csid, option)
end

entity.onEventFinish = function(player, csid, option, npc)
    xi.eschanHub.onSageEventFinish(player, 'Shiftrix', csid, option)
end
