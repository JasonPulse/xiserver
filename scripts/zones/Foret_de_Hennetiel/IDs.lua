...
zones[xi.zone.FORET_DE_HENNETIEL] =
{
    text =
    {
        ...
        FOUL_WATER_AT_RIVER_MOUTH     = 7505, -- Some foul-looking water bubbles forth at the mouth of the river.
        SOMETHING_APPROACHES          = 7506, -- Something approaches from behind as you bend down to take a sample!
        SAND_STRETCHES_OUT            = 7517, -- [Defiled/Pure white] sand stretches out before you.
        AURA_OF_TRANQUILITY           = 7518, -- An aura of tranquility embraces the land and soothes your heart.
