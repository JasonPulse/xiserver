...
-- from `xi-dat events 216`; the zone's other Repair_Trunk entities own no csids
...
local trunks =
{
    [17662780] = { xi.ki.MAGICKED_HEMPEN_SACK, 1508 },
    [17662781] = { xi.ki.MAGICKED_FLAXEN_SACK, 1511 },
}
