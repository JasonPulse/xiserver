...
--
-- Usage:
--   !setvar Sky_Selection N        (1=Tu'Lia / Hall of the Gods,
--                                   2=Sea / Al'Taieu)
--   then zone / relog
--
...
local destinations =
{
    [1] = { name = 'Tu\'Lia (Hall of the Gods)', zone = xi.zone.HALL_OF_THE_GODS,    x = 0, y = 0, z = 0, rot = 0 },
...
xi.skyAccess.tryWarp = function(player)
    ...
    if not dest then
        player:printToPlayer(string.format('Sky_Selection %d is not valid (1=Tu\'Lia, 2=Sea). See sky_access.lua.', pinned))
