...
xi.shop.curioVendorMoogleStock =
{
    [xi.shop.curio.medicine] =
    {
     ...
     -- { xi.item.ETHER,                   650, xi.ki.RHAPSODY_IN_WHITE   }, -- Removed by SE June 2021
        ...
        { xi.item.RERAISER,               1000, xi.ki.RHAPSODY_IN_WHITE   },
        { xi.item.RED_MOG_PELL,          10000, xi.ki.RHAPSODY_IN_WHITE   },
        { xi.item.GREEN_MOG_PELL,        10000, xi.ki.RHAPSODY_IN_WHITE   },
        { xi.item.GOLD_MOG_PELL,         10000, xi.ki.RHAPSODY_IN_WHITE   },
        { xi.item.RAINBOW_MOG_PELL,      10000, xi.ki.RHAPSODY_IN_WHITE   },
        { xi.item.OCHRE_MOG_PELL,        10000, xi.ki.RHAPSODY_IN_WHITE   },
        { xi.item.MARBLE_MOG_PELL,       10000, xi.ki.RHAPSODY_IN_WHITE   },
        { xi.item.SILVER_MOG_PELL,       10000, xi.ki.RHAPSODY_IN_WHITE   },
    },
    ...
    [xi.shop.curio.scrolls] =
    {
        ...
        { xi.item.TELEPORT_RING_HOLLA,      115500, xi.ki.RHAPSODY_IN_FUCHSIA },
        { xi.item.TELEPORT_RING_DEM,        115500, xi.ki.RHAPSODY_IN_FUCHSIA },
        { xi.item.TELEPORT_RING_MEA,        115500, xi.ki.RHAPSODY_IN_FUCHSIA },
    ...
    [xi.shop.curio.equipment] =
    {
        ...
        { xi.item.CUSTOM_VEST,          10000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.CUSTOM_F_GLOVES,      10000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.CUSTOM_PANTS,         10000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.CUSTOM_F_GLOVES,      10000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.CUSTOM_TUNIC,         10000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.CUSTOM_M_GLOVES,      10000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.CUSTOM_SLACKS,        10000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.CUSTOM_M_BOOTS,       10000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.MAGNA_BODICE,         10000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.MAGNA_GLOVES,         10000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.MAGNA_F_CHAUSSES,     10000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.MAGNA_F_LEDELSENS,    10000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.MAGNA_JERKIN,         10000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.MAGNA_GAUNTLETS,      10000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.MAGNA_M_CHAUSSES,     10000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.MAGNA_M_LEDELSENS,    10000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.WONDER_KAFTAN,        10000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.WONDER_MITTS,         10000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.WONDER_BRACCAE,       10000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.WONDER_CLOMPS,        10000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.SAVAGE_SEPARATES,     10000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.SAVAGE_GAUNTLETS,     10000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.SAVAGE_LOINCLOTH,     10000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.SAVAGE_GAITERS,       10000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.ELDERS_SURCOAT,       10000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.ELDERS_BRACERS,       10000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.ELDERS_BRAGUETTE,     10000, xi.ki.RHAPSODY_IN_UMBER },
        { xi.item.ELDERS_SANDALS,       10000, xi.ki.RHAPSODY_IN_UMBER },
