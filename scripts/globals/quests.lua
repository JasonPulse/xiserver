...
xi.quest.id =
{
    ...
    [xi.quest.area[xi.questLog.SANDORIA]] =
    {
        ...
        UNEXPECTED_TREASURE             = 70, -- + Converted
    ...
    [xi.quest.area[xi.questLog.BASTOK]] =
    {
        ...
        ESCORT_FOR_HIRE                 = 70, -- + Converted
        A_DISCERNING_EYE                = 71, -- + Converted
        ...
        ALL_BY_MYSELF                   = 76, -- + Converted
        A_QUESTION_OF_FAITH             = 77, -- + Converted
        RETURN_OF_THE_DEPTHS            = 78, -- + Converted
        TEAK_ME_TO_THE_STARS            = 79, -- + Converted
        HYPER_ACTIVE                    = 80, -- + Converted
        THE_NAMING_GAME                 = 81, -- + Converted
        CHIPS                           = 82, -- + Converted
        BAIT_AND_SWITCH                 = 83, -- + Converted
        LURE_OF_THE_WILDCAT             = 84, -- + Converted
        ACHIEVING_TRUE_POWER            = 85, -- + Converted
        TOO_MANY_CHEFS                  = 86, -- +
        A_PROPER_BURIAL                 = 87, -- + Converted
        FULLY_MENTAL_ALCHEMIST          = 88, -- + Converted
        SYNERGUSTIC_PURSUITS            = 89, -- + Converted
        THE_WONDROUS_WHATCHAMACALLIT    = 90, -- + Converted
        SYNERGISTIC_SUPPORT             = 91, -- + Converted
    ...
    {
        HAT_IN_HAND                     = 0,  -- +
        A_FEATHER_IN_ONES_CAP           = 1,  -- + Converted
        A_CRISIS_IN_THE_MAKING          = 2,  -- + Converted
        MAKING_AMENDS                   = 3,  -- + Converted
        MAKING_THE_GRADE                = 4,  -- + Converted
        IN_A_PICKLE                     = 5,  -- + Converted
        ...
        ESCORT_FOR_HIRE                 = 88, -- + Converted
        A_DISCERNING_EYE                = 89, -- + Converted
        TUNING_IN                       = 90, -- + Converted
        TUNING_OUT                      = 91, -- +
        ONE_GOOD_DEED                   = 92, -- + Converted
        WAKING_DREAMS                   = 93, -- + Converted
        LURE_OF_THE_WILDCAT             = 94, -- + Converted
        BABBAN_NY_MHEILLEA              = 95, -- + Converted
        TRUST_WINDURST                  = 96, -- + Converted
    },
    ...
    [xi.quest.area[xi.questLog.JEUNO]] =
    {
        ...
        MYSTERY_OF_FIRE                 = 33, -- + Converted
        MYSTERY_OF_WATER                = 34, -- + Converted
        MYSTERY_OF_EARTH                = 35, -- + Converted
        MYSTERY_OF_WIND                 = 36, -- + Converted
        MYSTERY_OF_ICE                  = 37, -- + Converted
        MYSTERY_OF_LIGHTNING            = 38, -- + Converted
        MYSTERY_OF_LIGHT                = 39, -- + Converted
        MYSTERY_OF_DARKNESS             = 40, -- + Converted
        FISTFUL_OF_FURY                 = 41, -- + Converted
        ...
        A_REPUTATION_IN_RUINS           = 73, -- + Converted
        ...
        GIRL_IN_THE_LOOKING_GLASS       = 78, -- + Converted
        MIRROR_MIRROR                   = 79, -- +
        PAST_REFLECTIONS                = 80, -- + Converted
        BLIGHTED_GLOOM                  = 81, -- + Converted
        BLESSED_RADIANCE                = 82, -- + Converted
        MIRROR_IMAGES                   = 83, -- + Converted
        CHAMELEON_CAPERS                = 84, -- + Converted
        REGAINING_TRUST                 = 85, -- + Converted
        STORMS_OF_FATE                  = 86, -- + Converted
        MIXED_SIGNALS                   = 87, -- + Converted
        ...
        A_FURIOUS_FINALE                = 99, -- + Converted
        THE_MIRACULOUS_DALE             = 100, -- + Converted
        CLASH_OF_THE_COMRADES           = 101, -- + Converted
        UNLOCKING_A_MYTH_WARRIOR        = 102, -- + Converted
        UNLOCKING_A_MYTH_MONK           = 103, -- + Converted
        UNLOCKING_A_MYTH_WHITE_MAGE     = 104, -- + Converted
        UNLOCKING_A_MYTH_BLACK_MAGE     = 105, -- + Converted
        UNLOCKING_A_MYTH_RED_MAGE       = 106, -- + Converted
        UNLOCKING_A_MYTH_THIEF          = 107, -- + Converted
        UNLOCKING_A_MYTH_PALADIN        = 108, -- + Converted
        UNLOCKING_A_MYTH_DARK_KNIGHT    = 109, -- + Converted
        UNLOCKING_A_MYTH_BEASTMASTER    = 110, -- + Converted
        UNLOCKING_A_MYTH_BARD           = 111, -- + Converted
        UNLOCKING_A_MYTH_RANGER         = 112, -- + Converted
        UNLOCKING_A_MYTH_SAMURAI        = 113, -- + Converted
        UNLOCKING_A_MYTH_NINJA          = 114, -- + Converted
        UNLOCKING_A_MYTH_DRAGOON        = 115, -- + Converted
        UNLOCKING_A_MYTH_SUMMONER       = 116, -- + Converted
        UNLOCKING_A_MYTH_BLUE_MAGE      = 117, -- + Converted
        UNLOCKING_A_MYTH_CORSAIR        = 118, -- + Converted
        UNLOCKING_A_MYTH_PUPPETMASTER   = 119, -- + Converted
        UNLOCKING_A_MYTH_DANCER         = 120, -- + Converted
        UNLOCKING_A_MYTH_SCHOLAR        = 121, -- + Converted
        ...
        A_TRIAL_IN_TANDEM               = 160, -- + Converted
        A_TRIAL_IN_TANDEM_REDUX         = 161, -- + Converted
        YET_ANOTHER_TRIAL_IN_TANDEM     = 162, -- + Converted
        A_QUATERNARY_TRIAL_IN_TANDEM    = 163, -- + Converted
        A_TRIAL_IN_TANDEM_REVISITED     = 164, -- + Converted
        ALL_IN_THE_CARDS                = 166, -- + Converted
        MARTIAL_MASTERY                 = 167, -- + Converted
        VW_OP_115_VALKURM_DUSTER        = 168, -- + Converted
    ...
    [xi.quest.area[xi.questLog.OTHER_AREAS]] =
    {
        ...
        ORLANDOS_ANTIQUES               = 7,  -- + Converted
        THE_SAND_CHARM                  = 8,  -- + Converted
        A_POTTERS_PREFERENCE            = 9,  -- + Converted
        THE_OLD_LADY                    = 10, -- + Converted
        FISHERMANS_HEART                = 11, -- + Converted
        DONATE_TO_RECYCLING             = 16, -- + Converted
        UNDER_THE_SEA                   = 17, -- + Converted
        ONLY_THE_BEST                   = 18, -- + Converted
        ...
        TRIAL_BY_LIGHTNING              = 27, -- + Converted
        ...
        SURVIVAL_OF_THE_WISEST          = 33, -- + Converted
        ...
        THE_BIG_ONE                     = 70, -- + Converted
        FLY_HIGH                        = 71, -- + Converted
        ...
        UNINVITED_GUESTS                = 81, -- + Converted
        TANGO_WITH_A_TRACKER            = 82, -- + Converted
        REQUIEM_OF_SIN                  = 83, -- + Converted
        VW_OP_026_TAVNAZIAN_TERRORS     = 84, -- + Converted
        VW_OP_004_BIBIKI_BOMBARDMENT    = 85, -- + Converted
        BOMBS_AWAY                      = 96, -- + Converted
        MITHRAN_DELICACIES              = 97, -- + Converted
        ...
        AN_UNDERSTANDING_OVERLORD       = 106, -- + Converted
        AN_AFFABLE_ADAMANTKING          = 107, -- + Converted
    ...
    [xi.quest.area[xi.questLog.CRYSTAL_WAR]] =
    {
        ...
        HEALING_HERBS                    = 3, -- + Converted
        REDEEMING_ROCKS                  = 4, -- + Converted
        ...
        BURDEN_OF_SUSPICION              = 20, -- + Converted
        EVIL_AT_THE_INLET                = 21, -- + Converted
        THE_FUMBLING_FRIAR               = 22, -- + Converted
        REQUIEM_FOR_THE_DEPARTED         = 23, -- + Converted
        BOY_AND_THE_BEAST                = 24, -- + Converted
        WRATH_OF_THE_GRIFFON             = 25, -- + Converted
        THE_LOST_BOOK                    = 26, -- + Converted
        KNOT_QUITE_THERE                 = 27, -- + Converted
        A_MANIFEST_PROBLEM               = 28, -- + Converted
        BEANS_AHOY                       = 29, -- +
        BEAST_FROM_THE_EAST              = 30, -- + Converted
        THE_SWARM                        = 31, -- + Converted
        ON_SABBATICAL                    = 32, -- + Converted
        DOWNWARD_HELIX                   = 33, -- + Converted
        SEEING_BLOOD_RED                 = 34, -- + Converted
        STORM_ON_THE_HORIZON             = 35, -- + Converted
        FIRE_IN_THE_HOLE                 = 36, -- + Converted
        PERILS_OF_THE_GRIFFON            = 37, -- + Converted
        IN_A_HAZE_OF_GLORY               = 38, -- + Converted
        WHEN_ONE_MAN_IS_NOT_ENOUGH       = 39, -- + Converted
        A_FEAST_FOR_GNATS                = 40, -- + Converted
        ...
        THE_LONG_MARCH_NORTH             = 46, -- + Converted
        THE_FORBIDDEN_PATH               = 47, -- + Converted
        A_JEWELERS_LAMENT                = 48, -- + Converted
        ...
        SINS_OF_THE_MOTHERS              = 53, -- + Converted
        HOWL_FROM_THE_HEAVENS            = 54, -- + Converted
        SUCCOR_TO_THE_SIDHE              = 55, -- + Converted
        THE_YOUNG_AND_THE_THREADLESS     = 56, -- + Converted
        SON_AND_FATHER                   = 57, -- + Converted
        THE_TRUTH_LIES_HID               = 58, -- + Converted
        BONDS_OF_MYTHRIL                 = 59, -- + Converted
        CHASING_SHADOWS                  = 60, -- + Converted
        FACE_OF_THE_FUTURE               = 61, -- + Converted
        MANIFEST_DESTINY                 = 62, -- + Converted
        AT_JOURNEYS_END                  = 63, -- + Converted
        ...
        HER_MEMORIES_AZURE_FOOTFALLS     = 70, -- + Converted
        HER_MEMORIES_VERDURE_FOOTFALLS   = 71, -- + Converted
        HER_MEMORIES_OF_MALIGN_MALADIES  = 72, -- + Converted
        CHAMPION_OF_THE_DAWN             = 73, -- + Converted
        THE_DAWN_ALSO_RISES              = 74, -- + Converted
        A_FORBIDDEN_REUNION              = 75, -- + Converted
        GUARDIAN_OF_THE_VOID             = 80, -- + Converted
        DRAFTED_BY_THE_DUCHY             = 81, -- + Converted
        BATTLE_ON_A_NEW_FRONT            = 82, -- + Converted
        VOIDWALKER_OP_126                = 83, -- + Converted
        A_CAIT_CALLS                     = 84, -- + Converted
        THE_TRUTH_IS_OUT_THERE           = 85, -- + Converted
        REDRAFTED_BY_THE_DUCHY           = 86, -- + Converted
        A_NEW_MENACE                     = 87, -- + Converted
        NO_REST_FOR_THE_WEARY            = 88, -- + Converted
        A_WORLD_IN_FLUX                  = 89, -- + Converted
        BETWEEN_A_ROCK_AND_RIFT          = 90, -- + Converted
        A_FAREWELL_TO_FELINES            = 91, -- + Converted
        THIRD_TOUR_OF_DUCHY              = 92, -- + Converted
        GLIMMER_OF_HOPE                  = 93, -- + Converted
        BRACE_FOR_THE_UNKNOWN            = 94, -- + Converted
        PROVENANCE                       = 95, -- + Converted
        CRYSTAL_GUARDIAN                 = 96, -- + Converted
        ENDINGS_AND_BEGINNINGS           = 97, -- + Converted
        AD_INFINITUM                     = 98, -- + Converted
    },
    ...
    [xi.quest.area[xi.questLog.ADOULIN]] =
    {
        ...
        ENDEAVORING_TO_AWAKEN            = 22, -- + Converted
        FORGING_NEW_BONDS                = 23, -- + Converted
        LEGACIES_LOST_AND_FOUND          = 24, -- + Converted
        DESTINYS_DEVICE                  = 25, -- + Converted
        ...
        DIRT_CHEAP                       = 33,
        FLOWER_POWER                     = 34,
        ELEMENTARY_MY_DEAR_SYLVIE        = 35, -- + Converted
        FOR_WHOM_THE_BELL_TOLLS          = 36, -- + Converted
        THE_BLOODLINE_OF_ZACARIAH        = 37, -- + Converted
        THE_COMMUNION                    = 38, -- + Converted
        ...
        SCAREDYCATS                      = 72,
        RAPTOR_RAPTURE                   = 73,
        EXOTIC_DELICACIES                = 74, -- + Converted
        ...
        FERTILE_GROUND                   = 85,
        ALWAYS_MORE_QUOTH_THE_RAVENOUS   = 88, -- + Converted
        MEGALOMANIAC                     = 89,
