...
-----------------------------------
-- Log ID: 8, Quest ID: 142
-- Machine Outfitter : La Theine Abyssea camp
-- !addquest 8 142
-----------------------------------
-- Retail (bg-wiki "Refuel and Replenish (La Theine)").
-- |Start=Machine Outfitter (La Theine), Abyssea - La Theine
-- |Fame=alth |FLevel=1  |Repeatable=Yes
...
local quest = Quest:new(xi.questLog.ABYSSEA, xi.quest.id.abyssea.REFUEL_AND_REPLENISH_LA_THEINE)
