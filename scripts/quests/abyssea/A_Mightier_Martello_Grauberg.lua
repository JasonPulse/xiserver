...
-----------------------------------
-- Log ID: 8, Quest ID: 159
-- Machine Outfitter : Grauberg Abyssea camp
-- !addquest 8 159
-----------------------------------
-- Retail (bg-wiki "A Mightier Martello (Grauberg)").
-- |Start=Machine Outfitter (Grauberg), Abyssea - Grauberg
-- |Fame=agra |FLevel=3  |Repeatable=Yes
...
local quest = Quest:new(xi.questLog.ABYSSEA, xi.quest.id.abyssea.A_MIGHTIER_MARTELLO_GRAUBERG)
