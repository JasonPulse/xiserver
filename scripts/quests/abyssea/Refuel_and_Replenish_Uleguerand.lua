...
-----------------------------------
-- Log ID: 8, Quest ID: 149
-- Machine Outfitter : Uleguerand Abyssea camp
-- !addquest 8 149
-----------------------------------
-- Retail (bg-wiki "Refuel and Replenish (Uleguerand)").
-- |Start=Machine Outfitter (Uleguerand), Abyssea - Uleguerand
-- |Fame=aule |FLevel=1  |Repeatable=Yes
...
local quest = Quest:new(xi.questLog.ABYSSEA, xi.quest.id.abyssea.REFUEL_AND_REPLENISH_ULEGUERAND)
