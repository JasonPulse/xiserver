...
-----------------------------------
-- Log ID: 8, Quest ID: 157
-- Machine Outfitter : Altepa Abyssea camp
-- !addquest 8 157
-----------------------------------
-- Retail (bg-wiki "A Mightier Martello (Altepa)").
-- |Start=Machine Outfitter (Altepa), Abyssea - Altepa
-- |Fame=aalt |FLevel=3  |Repeatable=Yes
...
local quest = Quest:new(xi.questLog.ABYSSEA, xi.quest.id.abyssea.A_MIGHTIER_MARTELLO_ALTEPA)
