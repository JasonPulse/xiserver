...
-----------------------------------
-- Log ID: 8, Quest ID: 144
-- Machine Outfitter : Tahrongi Abyssea camp
-- !addquest 8 144
-----------------------------------
-- Retail (bg-wiki "Refuel and Replenish (Tahrongi)").
-- |Start=Machine Outfitter (Tahrongi), Abyssea - Tahrongi
-- |Fame=atah |FLevel=1  |Repeatable=Yes
...
local quest = Quest:new(xi.questLog.ABYSSEA, xi.quest.id.abyssea.REFUEL_AND_REPLENISH_TAHRONGI)
