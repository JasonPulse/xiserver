...
-----------------------------------
-- Log ID: 8, Quest ID: 152
-- Machine Outfitter : Konschtat Abyssea camp
-- !addquest 8 152
-----------------------------------
-- Retail (bg-wiki "A Mightier Martello (Konschtat)").
-- |Start=Machine Outfitter (Konschtat), Abyssea - Konschtat
-- |Fame=akon |FLevel=3  |Repeatable=Yes
...
local quest = Quest:new(xi.questLog.ABYSSEA, xi.quest.id.abyssea.A_MIGHTIER_MARTELLO_KONSCHTAT)
