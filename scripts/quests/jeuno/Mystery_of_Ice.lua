...
-----------------------------------
local quest = Quest:new(xi.questLog.JEUNO, xi.quest.id.jeuno.MYSTERY_OF_ICE)
...
quest.sections =
{
        ...
        [xi.zone.UPPER_JEUNO] =
        {
            ['Laila'] =
            {
                onTrigger = function(player, npc)
                    return quest:progressEvent(10195)
                end,
            },
...

    {
        ...
        [xi.zone.UPPER_JEUNO] =
        {
            ...
            {
                onTrigger = function(player, npc)
                    return quest:progressEvent(10196)
                end,
            },
