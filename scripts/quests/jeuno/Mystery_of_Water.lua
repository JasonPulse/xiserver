...
-----------------------------------
local quest = Quest:new(xi.questLog.JEUNO, xi.quest.id.jeuno.MYSTERY_OF_WATER)
...
quest.sections =
{
        ...
        [xi.zone.UPPER_JEUNO] =
        {
            ['Laila'] =
            {
                onTrigger = function(player, npc)
                    return quest:progressEvent(10189)
                end,
            },

            onEventFinish =
            {
                [10189] = function(player, csid, option, npc)
                    if option == 1 then
                        quest:begin(player)
                    end
                end,
...

    {
        ...
        [xi.zone.UPPER_JEUNO] =
        {
            ...
            {
                onTrigger = function(player, npc)
                    return quest:progressEvent(10190)
                end,
            },
