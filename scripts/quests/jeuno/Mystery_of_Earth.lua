...
-----------------------------------
local quest = Quest:new(xi.questLog.JEUNO, xi.quest.id.jeuno.MYSTERY_OF_EARTH)
...
quest.sections =
{
...

    {
        ...
        [xi.zone.UPPER_JEUNO] =
        {
            ...
            {
                onTrigger = function(player, npc)
                    return quest:progressEvent(10192)
                end,
            },
