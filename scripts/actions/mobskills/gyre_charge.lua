...
mobskillObject.onMobWeaponSkill = function(target, mob, skill)
    ...
    local damage = xi.mobskills.mobFinalAdjustments(info.dmg, mob, skill, target, xi.attackType.PHYSICAL, xi.damageType.BLUNT, xi.mobskills.shadowBehavior.NUMSHADOWS_1, info.hitslanded)
