-----------------------------------
--  Blast of Reticence
--  Description: Deals Wind damage. Additional effect: Silence.
--  Type: Magical
...
--   Class Magical | Type Wind | Effect: "Damage + Silence"
--
-- MODELLED ON: great_whirlwind.lua -- the repo's canonical "elemental magical
-- damage + one status effect" mobskill.
-- Silence power 1 / duration 60 is the repo's standard mob Silence block.
-----------------------------------
---@type TMobSkill
