...
-- On this small private server the campaign is always on — wide date range so
-- players can earn and spend points whenever they log in.
local loginCampaignStart  = { year = 2020, month = 1,  day = 1,  hour = 0  }
