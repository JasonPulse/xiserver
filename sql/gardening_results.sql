...
insert into `gardening_results`
(
    `resultId`, `seed`, `element1`, `element2`, `result`, `min_quantity`, `max_quantity`, `weight`
)
VALUES
...
UPDATE 
    ...
    `seed` = IF(`seed` <> VALUES(`seed`), VALUES(`seed`), `seed`),
    `element1` = IF(`element1` <> VALUES(`element1`), VALUES(`element1`), `element1`),
    `element2` = IF(`element2` <> VALUES(`element2`), VALUES(`element2`), `element2`),
    `result` = IF(`result` <> VALUES(`result`), VALUES(`result`), `result`),
    `min_quantity` = IF(`min_quantity` <> VALUES(`min_quantity`), VALUES(`min_quantity`), `min_quantity`),
    `max_quantity` = IF(`max_quantity` <> VALUES(`max_quantity`), VALUES(`max_quantity`), `max_quantity`),
    `weight` = IF(`weight` <> VALUES(`weight`), VALUES(`weight`), `weight`)
;
...
VALUES
    ...
    (1934,7,0,0,1261,1,1,12), -- Light Ore
    ...
    (1940,7,0,1,1255,1,1,6), -- Fire Ore
    (1941,7,0,1,1261,1,1,6), -- Light Ore
    ...
    (1947,7,0,2,1256,1,1,6), -- Ice Ore
    (1948,7,0,2,1261,1,1,6), -- Light Ore
    ...
    (1954,7,0,3,1257,1,1,6), -- Wind Ore
    (1955,7,0,3,1261,1,1,6), -- Light Ore
    ...
    (1961,7,0,4,1258,1,1,6), -- Earth Ore
    (1962,7,0,4,1261,1,1,6), -- Light Ore
    ...
    (1968,7,0,5,1259,1,1,6), -- Lightning Ore
    (1969,7,0,5,1261,1,1,6), -- Light Ore
    ...
    (1975,7,0,6,1260,1,1,6), -- Water Ore
    (1976,7,0,6,1261,1,1,6), -- Light Ore
    ...
    (1982,7,0,7,1261,1,1,6), -- Light Ore
    ...
    (1988,7,0,8,1261,1,1,6), -- Light Ore
    (1989,7,0,8,1262,1,1,6), -- Dark Ore
    ...
    (1995,7,1,0,1255,1,1,6), -- Fire Ore
    (1996,7,1,0,1261,1,1,6), -- Light Ore
    (1997,7,1,1,4105,1,2,48), -- Ice Cluster
    (1998,7,1,1,628,1,2,40), -- Cinnamon
    (1999,7,1,1,1255,1,1,12), -- Fire Ore
    ...
    (2004,7,1,2,1255,1,1,6), -- Fire Ore
    (2005,7,1,2,1256,1,1,6), -- Ice Ore
    ...
    (2010,7,1,3,1255,1,1,6), -- Fire Ore
    (2011,7,1,3,1257,1,1,6), -- Wind Ore
    ...
    (2016,7,1,4,1255,1,1,6), -- Fire Ore
    (2017,7,1,4,1258,1,1,6), -- Earth Ore
    ...
    (2022,7,1,5,1255,1,1,6), -- Fire Ore
    (2023,7,1,5,1259,1,1,6), -- Lightning Ore
    ...
    (2028,7,1,6,1255,1,1,6), -- Fire Ore
    (2029,7,1,6,1260,1,1,6), -- Water Ore
    ...
    (2034,7,1,7,1255,1,1,6), -- Fire Ore
    ...
    (2040,7,1,8,1255,1,1,6), -- Fire Ore
    (2041,7,1,8,4274,4,8,14), -- Persikos
    (2042,7,1,8,1262,1,1,6), -- Dark Ore
    ...
    (2048,7,2,0,1256,1,1,6), -- Ice Ore
    (2049,7,2,0,1261,1,1,6), -- Light Ore
    ...
    (2054,7,2,1,1255,1,1,6), -- Fire Ore
    (2055,7,2,1,1256,1,1,6), -- Ice Ore
    (2056,7,2,2,4106,1,2,48), -- Wind Cluster
    (2057,7,2,2,1310,6,12,40), -- Platinum Leaf
    (2058,7,2,2,1256,1,1,12), -- Ice Ore
    ...
    (2063,7,2,3,1256,1,1,6), -- Ice Ore
    (2064,7,2,3,1257,1,1,6), -- Wind Ore
    ...
    (2069,7,2,4,1256,1,1,6), -- Ice Ore
    (2070,7,2,4,1258,1,1,6), -- Earth Ore
    ...
    (2075,7,2,5,1256,1,1,6), -- Ice Ore
    (2076,7,2,5,1259,1,1,6), -- Lightning Ore
    ...
    (2081,7,2,6,1256,1,1,6), -- Ice Ore
    (2082,7,2,6,1260,1,1,6), -- Water Ore
    ...
    (2093,7,2,8,1256,1,1,6), -- Ice Ore
    (2094,7,2,8,4274,4,8,14), -- Persikos
    (2095,7,2,8,1262,1,1,6), -- Dark Ore
    ...
    (2101,7,3,0,1257,1,1,6), -- Wind Ore
    (2102,7,3,0,1261,1,1,6), -- Light Ore
    ...
    (2107,7,3,1,1255,1,1,6), -- Fire Ore
    (2108,7,3,1,1257,1,1,6), -- Wind Ore
    ...
    (2122,7,3,4,1257,1,1,6), -- Wind Ore
    (2123,7,3,4,1258,1,1,6), -- Earth Ore
    ...
    (2128,7,3,5,1257,1,1,6), -- Wind Ore
    (2129,7,3,5,1259,1,1,6), -- Lightning Ore
    ...
    (2134,7,3,6,1257,1,1,6), -- Wind Ore
    (2135,7,3,6,1260,1,1,6), -- Water Ore
    ...
    (2140,7,3,7,1257,1,1,6), -- Wind Ore
    ...
    (2146,7,3,8,1257,1,1,6), -- Wind Ore
    (2147,7,3,8,4274,4,8,14), -- Persikos
    (2148,7,3,8,1262,1,1,6), -- Dark Ore
    ...
    (2154,7,4,0,1258,1,1,6), -- Earth Ore
    (2155,7,4,0,1261,1,1,6), -- Light Ore
    ...
    (2160,7,4,1,1255,1,1,6), -- Fire Ore
    (2161,7,4,1,1258,1,1,6), -- Earth Ore
    ...
    (2166,7,4,2,1256,1,1,6), -- Ice Ore
    (2167,7,4,2,1258,1,1,6), -- Earth Ore
    ...
    (2172,7,4,3,1257,1,1,6), -- Wind Ore
    (2173,7,4,3,1258,1,1,6), -- Earth Ore
    (2174,7,4,4,4108,1,2,48), -- Lightning Cluster
    (2175,7,4,4,4273,8,16,40), -- Kitron
    (2176,7,4,4,1258,1,1,12), -- Earth Ore
    ...
    (2181,7,4,5,1258,1,1,6), -- Earth Ore
    (2182,7,4,5,1259,1,1,6), -- Lightning Ore
    ...
    (2187,7,4,6,1258,1,1,6), -- Earth Ore
    (2188,7,4,6,1260,1,1,6), -- Water Ore
    ...
    (2193,7,4,7,1258,1,1,6), -- Earth Ore
    ...
    (2199,7,4,8,1258,1,1,6), -- Earth Ore
    (2200,7,4,8,4274,4,8,14), -- Persikos
    (2201,7,4,8,1262,1,1,6), -- Dark Ore
    ...
    (2207,7,5,0,1259,1,1,6), -- Lightning Ore
    (2208,7,5,0,1261,1,1,6), -- Light Ore
    ...
    (2213,7,5,1,1255,1,1,6), -- Fire Ore
    (2214,7,5,1,1259,1,1,6), -- Lightning Ore
    ...
    (2219,7,5,2,1256,1,1,6), -- Ice Ore
    (2220,7,5,2,1259,1,1,6), -- Lightning Ore
    ...
    (2225,7,5,3,1257,1,1,6), -- Wind Ore
    (2226,7,5,3,1259,1,1,6), -- Lightning Ore
    ...
    (2231,7,5,4,1258,1,1,6), -- Earth Ore
    (2232,7,5,4,1259,1,1,6), -- Lightning Ore
    (2233,7,5,5,4109,1,2,48), -- Water Cluster
    (2234,7,5,5,1307,8,16,40), -- Silver Leaf
    (2235,7,5,5,1259,1,1,12), -- Lightning Ore
    ...
    (2240,7,5,6,1259,1,1,6), -- Lightning Ore
    (2241,7,5,6,1260,1,1,6), -- Water Ore
    ...
    (2246,7,5,7,1259,1,1,6), -- Lightning Ore
    ...
    (2252,7,5,8,1259,1,1,6), -- Lightning Ore
    (2253,7,5,8,4274,4,8,14), -- Persikos
    (2254,7,5,8,1262,1,1,6), -- Dark Ore
    ...
    (2260,7,6,0,1260,1,1,6), -- Water Ore
    (2261,7,6,0,1261,1,1,6), -- Light Ore
    ...
    (2266,7,6,1,1255,1,1,6), -- Fire Ore
    (2267,7,6,1,1260,1,1,6), -- Water Ore
    ...
    (2272,7,6,2,1256,1,1,6), -- Ice Ore
    (2273,7,6,2,1260,1,1,6), -- Water Ore
    ...
    (2278,7,6,3,1257,1,1,6), -- Wind Ore
    (2279,7,6,3,1260,1,1,6), -- Water Ore
    ...
    (2284,7,6,4,1258,1,1,6), -- Earth Ore
    (2285,7,6,4,1260,1,1,6), -- Water Ore
    ...
    (2290,7,6,5,1259,1,1,6), -- Lightning Ore
    (2291,7,6,5,1260,1,1,6), -- Water Ore
    (2292,7,6,6,4104,1,2,48), -- Fire Cluster
    (2293,7,6,6,1308,6,12,40), -- Mythril Leaf
    (2294,7,6,6,1260,1,1,12), -- Water Ore
    ...
    (2299,7,6,7,1260,1,1,6), -- Water Ore
    ...
    (2305,7,6,8,1260,1,1,6), -- Water Ore
    (2306,7,6,8,4274,4,8,14), -- Persikos
    (2307,7,6,8,1262,1,1,6), -- Dark Ore
    ...
    (2313,7,7,0,1261,1,1,6), -- Light Ore
    ...
    (2318,7,7,1,1255,1,1,6), -- Fire Ore
    ...
    (2330,7,7,3,1257,1,1,6), -- Wind Ore
    ...
    (2336,7,7,4,1258,1,1,6), -- Earth Ore
    ...
    (2342,7,7,5,1259,1,1,6), -- Lightning Ore
    ...
    (2348,7,7,6,1260,1,1,6), -- Water Ore
    ...
    (2359,7,7,8,1262,1,1,6), -- Dark Ore
    ...
    (2365,7,8,0,1261,1,1,6), -- Light Ore
    (2366,7,8,0,1262,1,1,6), -- Dark Ore
    ...
    (2371,7,8,1,1255,1,1,6), -- Fire Ore
    (2372,7,8,1,4274,4,8,14), -- Persikos
    (2373,7,8,1,1262,1,1,6), -- Dark Ore
    ...
    (2378,7,8,2,1256,1,1,6), -- Ice Ore
    (2379,7,8,2,4274,4,8,14), -- Persikos
    (2380,7,8,2,1262,1,1,6), -- Dark Ore
    ...
    (2385,7,8,3,1257,1,1,6), -- Wind Ore
    (2386,7,8,3,4274,4,8,14), -- Persikos
    (2387,7,8,3,1262,1,1,6), -- Dark Ore
    ...
    (2392,7,8,4,1258,1,1,6), -- Earth Ore
    (2393,7,8,4,4274,4,8,14), -- Persikos
    (2394,7,8,4,1262,1,1,6), -- Dark Ore
    ...
    (2399,7,8,5,1259,1,1,6), -- Lightning Ore
    (2400,7,8,5,4274,4,8,14), -- Persikos
    (2401,7,8,5,1262,1,1,6), -- Dark Ore
    ...
    (2406,7,8,6,1260,1,1,6), -- Water Ore
    (2407,7,8,6,4274,4,8,14), -- Persikos
    (2408,7,8,6,1262,1,1,6), -- Dark Ore
