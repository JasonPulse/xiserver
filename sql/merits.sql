...
insert into `merits`
(
    `meritid`, `name`, `upgrade`, `value`, `jobs`, `upgradeid`, `catagoryid`
)
VALUES
    (64,'max_hp',15,10,1048575,0,0),
    (66,'max_mp',15,10,1048575,0,0),
    (68,'max_merits',45,1,1048575,9,0),
    ...
    (448,'focus_recast',5,4,2,6,6),
    (450,'dodge_recast',5,4,2,6,6),
    (452,'chakra_recast',5,6,2,6,6),
    ...
    (768,'shield_bash_recast',5,2,64,6,11),
    ...
    (1664,'shijin_spiral',5,3,131074,8,25),
    (1666,'exenterator',5,3,333617,8,25),
    (1668,'requiescat',5,3,113361,8,25),
    (1670,'resolution',5,3,193,8,25),
    (1672,'ruinator',5,3,1409,8,25),
    (1674,'upheaval',5,3,129,8,25),
    (1676,'entropy',5,3,385,8,25),
    (1678,'stardiver',5,3,10241,8,25),
    (1680,'blade_shun',5,3,4096,8,25),
    (1682,'tachi_shoha',5,3,2048,8,25),
    (1684,'realmrazer',5,3,573519,8,25),
    (1686,'shattersoul',5,3,549455,8,25),
    (1688,'apex_arrow',5,3,3072,8,25),
    (1690,'last_stand',5,3,66592,8,25),
    (1728,'full_circle_effect',5,1,1048576,6,26),
    (1730,'ecliptic_attrition_recast',5,10,1048576,6,26),
    (1732,'life_cycle_recast',5,20,1048576,6,26),
    (1734,'blaze_of_glory_recast',5,20,1048576,6,26),
    (1736,'dematerialize_recast',5,20,1048576,6,26),
    (1792,'rune_enchantment_effect',5,2,2097152,6,27),
    (1794,'vallation_effect',5,1,2097152,6,27),
    (1796,'lunge_effect',5,3,2097152,6,27),
    (1798,'pflug_effect',5,1,2097152,6,27),
    (1800,'gambit_recast',5,10,2097152,6,27),
    (2048,'warriors_charge',5,5,1,7,31),
    (2050,'tomahawk',5,15,1,7,31),
    (2052,'savagery',5,100,1,7,31),
    ...
    (2184,'animus_solace',5,2,4,7,33),
    (2186,'animus_misery',5,5,4,7,33),
    ...
    (2252,'anc_magic_attack_bonus',5,3,8,7,34),
    (2254,'anc_magic_burst_dmg',5,3,8,7,34),
    (2256,'ele_magic_acc',5,5,8,7,34),
    (2258,'ele_magic_debuff_duration',5,12,8,7,34),
    (2260,'ele_magic_debuff_effect',5,1,8,7,34),
    (2262,'aspir_absorption_amount',5,4,8,7,34),
    ...
    (2316,'enfeebling_magic_duration',5,6,16,7,35),
    (2318,'magic_accuracy',5,5,16,7,35),
    (2320,'enhancing_magic_duration',5,6,16,7,35),
    (2322,'immunobreak_chance',5,3,16,7,35),
    (2324,'enspell_damage',5,3,16,7,35),
    (2326,'melee_accuracy',5,5,16,7,35),
    ...
    (2496,'dark_seal',5,10,128,7,38),
    (2498,'diabolic_eye',5,1,128,7,38),
    ...
    (2632,'con_anima',5,1,512,7,40),
    (2634,'con_brio',5,1,512,7,40),
    ...
    (2832,'yonin_effect',5,50,4096,7,43),
    (2834,'innin_effect',5,1,4096,7,43),
    (2836,'nin_magic_accuracy',5,5,4096,7,43),
    (2838,'nin_magic_attack',5,4,4096,7,43),
    (2880,'deep_breathing',5,1,8192,7,44),
    (2882,'angon',5,15,8192,7,44),
    (2884,'empathy',5,1,8192,7,44),
    (2886,'strafe_effect',5,10,8192,7,44),
    ...
    (3012,'enchainment',5,100,32768,7,46),
    (3014,'assimilation',5,1,32768,7,46),
    (3072,'snake_eye',5,10,65536,7,47),
    ...
    (3392,'mending_halation',5,1,1048576,7,52),
    (3394,'radial_arcana',5,1,1048576,7,52),
    (3396,'curative_recantation',5,1,1048576,7,52),
    (3398,'primeval_zeal',5,10,1048576,7,52),
    (3456,'battuta',5,4,2097152,7,53),
    (3458,'rayke',5,3,2097152,7,53),
    (3460,'inspiration',5,10,2097152,7,53),
    (3462,'sleight_of_sword',5,5,2097152,7,53)
ON DUPLICATE KEY 
UPDATE 
    ...
    `upgradeid` = IF(`upgradeid` <> VALUES(`upgradeid`), VALUES(`upgradeid`), `upgradeid`),
    `catagoryid` = IF(`catagoryid` <> VALUES(`catagoryid`), VALUES(`catagoryid`), `catagoryid`)
;
