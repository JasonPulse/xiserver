...
insert into `job_point_gifts`
(
    `jobid`, `jp_needed`, `modid`, `value`, `desc`
)
VALUES
    ...
    (2,500,997,1,'MNK_Superior 3'),
    (2,545,915,23,'MNK_Capacity Point Bonus'),
    (2,550,1047,5,'MNK_Counter Damage'),
    ...
    (4,980,274,6,'BLM_Magic Burst Damage Bonus'),
    ...
    (5,1900,432,7,'RDM_Enspell Damage'),
    (5,2000,170,2,'RDM_Fast Cast Effect'),
    (5,2100,997,1,'RDM_Superior 5'),
    ...
    (6,50,997,1,'THF_Superior 1'),
    (6,55,915,9,'THF_Capacity Point Bonus'),
    (6,60,30,5,'THF_Magic Accuracy Bonus'),
    (6,80,1048,5,'THF_"Treasure Hunter" Bonus'),
    (6,95,915,11,'THF_Capacity Point Bonus'),
    (6,100,1049,1,'THF_Maximum Treasure Hunter Value'),
    (6,100,997,1,'THF_Superior 2'),
    ...
    (6,980,1048,6,'THF_Treasure Hunter Bonus'),
    ...
    (6,1200,1049,1,'THF_Maximum Treasure Hunter Value'),
    (6,1200,997,1,'THF_Superior 4'),
    ...
    (7,500,997,1,'PLD_Superior 3'),
    (7,545,915,23,'PLD_Capacity Point Bonus'),
    (7,550,1050,10,'PLD_Protect Effect'),
    ...
    (7,1200,1051,50,'PLD_Cure Potency Bonus'),
    (7,1200,997,1,'PLD_Superior 4'),
...
VALUES
    ...
    (9,100,1052,5,'BST_Sic and Ready Recast Time'),
    (9,100,997,1,'BST_Superior 2'),
    ...
    (11,100,423,5,'RNG_Velocity Shot Effect'),
    (11,100,997,1,'RNG_Superior 2'),
    (11,125,1053,2,'RNG_True Shot Effect'),
    (11,145,915,13,'RNG_Capacity Point Bonus'),
    (11,150,1054,2,'RNG_Dead Aim Effect'),
    ...
    (11,450,1053,2,'RNG_True Shot Effect'),
    (11,500,1054,2,'RNG_Dead Aim Effect'),
    (11,500,997,1,'RNG_Superior 3'),
    ...
    (11,1050,1053,2,'RNG_True Shot Effect'),
    (11,1125,1054,2,'RNG_Dead Aim Effect'),
    (11,1195,915,33,'RNG_Capacity Point Bonus'),
    (11,1200,423,5,'RNG_Velocity Shot Effect'),
    (11,1200,997,1,'RNG_Superior 4'),
    ...
    (11,1900,1053,2,'RNG_True Shot Effect'),
    (11,2000,1054,2,'RNG_Dead Aim Effect'),
    (11,2100,997,1,'RNG_Superior 5'),
    ...
    (12,100,306,5,'SAM_Zanshin Effect'),
    (12,100,997,1,'SAM_Superior 2'),
    ...
    (12,500,997,1,'SAM_Superior 3'),
    (12,545,915,23,'SAM_Capacity Point Bonus'),
    (12,550,1055,1,'SAM_Third Eye Effect'),
    ...
    (12,1200,306,5,'SAM_Zanshin Effect'),
    (12,1200,997,1,'SAM_Superior 4'),
    ...
    (13,500,997,1,'NIN_Superior 3'),
    (13,545,915,23,'NIN_Capacity Point Bonus'),
    (13,550,1000,10,'NIN_Ninjutsu Effect Duration'),
    ...
    (14,100,1056,1,'DRG_Wyvern Attribute Increase Effect'),
    (14,5,997,1,'DRG_Superior 2'),
    ...
    (14,500,997,1,'DRG_Superior 3'),
    (14,545,915,23,'DRG_Capacity Point Bonus'),
    (14,550,1057,10,'DRG_Restoring/Smiting Breath Delay'),
    ...
    (14,1200,1056,2,'DRG_Wyvern Attribute Increase Effect'),
    (14,1200,997,1,'DRG_Superior 4'),
    ...
    (15,45,990,15,'SMN_Avatar/Spirit Phys. Atk. & Def. Bonus'),
    (15,50,997,1,'SMN_Superior 1'),
...
VALUES
    ...
    (15,320,990,23,'SMN_Avatar/Spirit Phys. Atk. & Def. Bonus'),
    ...
    (15,845,990,30,'SMN_Avatar/Spirit Phys. Atk. & Def. Bonus'),
    ...
    (15,1620,990,38,'SMN_Avatar/Spirit Phys. Atk. & Def. Bonus'),
    ...
    (16,100,997,1,'BLU_Superior 2'),
    (16,100,1058,1,'BLU_Job Trait Bonus'),
    ...
    (16,1200,997,1,'BLU_Superior 4'),
    (16,1200,1058,1,'BLU_Jobs Trait Bonus'),
    ...
    (17,500,997,1,'COR_Superior 3'),
    (17,500,1053,2,'COR_True Shot Effect'),
    (17,545,915,23,'COR_Capacity Point Bonus'),
    (17,550,1060,10,'COR_Quick Draw Delay'),
    ...
    (17,1125,1053,2,'COR_True Shot Effect'),
    (17,1195,915,33,'COR_Capacity Point Bonus'),
    (17,1200,997,1,'COR_Superior 4'),
    ...
    (17,2000,1053,2,'COR_True Shot Effect'),
    (17,2100,997,1,'COR_Superior 5'),
    ...
    (18,100,987,2,'PUP_Automaton Elemental Capacity Bonus'),
    (18,100,997,1,'PUP_Superior 2'),
    ...
    (18,1200,997,1,'PUP_Superior 4'),
    (18,1200,987,2,'PUP_Automation Elemental Capacity Bonus'),
    ...
    (20,500,997,1,'SCH_Superior 3'),
    (20,500,274,3,'SCH_Magic Burst Damage Bonus'),
    (20,545,915,23,'SCH_Capacity Point Bonus'),
    (20,550,1159,15,'SCH_Stratagem Recast Time'),
    ...
    (20,1125,274,3,'SCH_Magic Burst Damage Bonus'),
    (20,1195,915,33,'SCH_Capacity Point Bonus'),
    (20,1200,997,1,'SCH_Superior 4'),
    ...
    (20,2000,274,4,'SCH_Magic Burst Damage Bonus'),
    (20,2100,997,1,'SCH_Superior 5'),
    ...
    (22,500,997,1,'RUN_Superior 3'),
    (22,500,963,2,'RUN_Inquartata Effect'),
    ...
    (22,1125,963,2,'RUN_Inquartata Effect'),
    (22,1195,915,33,'RUN_Capacity Point Bonus'),
    (22,1200,997,1,'RUN_Superior 4'),
    ...
    (22,2000,963,2,'RUN_Inquartata Effect'),
    (22,2100,997,1,'RUN_Superior 5'),
