...
- **Geas Fete** -- PARTIAL (2026-06-09): `scripts/globals/geas_fete.lua` with popBoss/grantRewards. 5 Gods (Byakko/Genbu/Seiryu/Suzaku/Kirin) + 5 Ark Angels (HM/EV/TT/MR/GK) death scripts in Escha-RuAun. Pop table covers 20 NMs (5 Gods + 5 AAs + 5 standard Ru'Aun + 3 ZiTah + 3 Reisenjima as starter); extend xi.geasFete.pops with more entries to cover the remaining 60+ Geas Fete NMs. 3000 bayld alliance reward.
